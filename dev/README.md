...
ansible-playbook test/test_vlan.yml test/test_switch.yml test/test_ippool.yml test/test_table.yml test/test_device.yml
```
...
```
release_summary: |
  This is the first proper release of ``nils_ost.lpos`` collection on 2026-06-01.
